import { TSchema } from "../../validators/handlers/getDetailedScore";
 ...
 */
export type ResponseDetails = Pick<
  QuizQuestionReponse,
  "gptExplanation" | "answer" | "supportingInfo"
>;
 ...
 */
export type TReturn = ResponseDetails;
