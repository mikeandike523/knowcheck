module.exports = {
  ...
  questions: [
    {
      body:
        'What are the criteria indicating that a patient should be admitted as an inpatient under the diagnosis "COPD with Acute Exacerbation"?',
      supportingInfo: [
    ...
    {
      body:
        'What are the criteria indicating that a patient should be admitted as an inpatient under the diagnosis "Pneumonia"?',
      supportingInfo: [
    ...
    {
      body:
        'What are the criteria indicating that a patient should be admitted as an inpatient under the diagnosis "AKI (Acute Kidney Injury)"?',
      supportingInfo: [
    ...
    {
      body:
        'What are the criteria indicating that a patient should be admitted as an inpatient under the diagnosis "Developed AKI Post Admission"?',
      supportingInfo: [
    ...
    {
      body:
        'What are the criteria indicating that a patient should be admitted as an inpatient under the diagnosis "Acute Pancreatitis"?',
      supportingInfo: [
    ...
    {
      body:
        'What are the criteria indicating that a patient should be admitted as an inpatient under the diagnosis "Atrial Fibrillation"?',
      supportingInfo: [
    ...
    {
      body:
        'What are the criteria indicating that a patient should be admitted as an inpatient under the diagnosis "Hypocalcemia"?',
      supportingInfo: [
    ...
    {
      body:
        'What are the criteria indicating that a patient should be admitted as an inpatient under the diagnosis "Hypercalcemia"?',
      supportingInfo: [
    ...
    {
      body:
        'What are the criteria indicating that a patient should be admitted as an inpatient under the diagnosis "Hypokalemia"?',
      supportingInfo: [
    ...
    {
      body:
        'What are the criteria indicating that a patient should be admitted as an inpatient under the diagnosis "Hyperkalemia"?',
      supportingInfo: [
        "K+ level exceeds 6",
    ...
    {
      body:
        'What are the criteria indicating that a patient should be admitted as an inpatient under the diagnosis "UTI"?',
      supportingInfo: [
    ...
    {
      body:
        'What are the criteria indicating that a patient should be admitted as an inpatient under the diagnosis "COPD"?',
      supportingInfo: [
    ...
    {
      body:
        'What are the criteria indicating that a patient should be admitted as an inpatient under the diagnosis "Chest Pain"?',
      supportingInfo: [
    ...
    {
      body:
        'What are the criteria indicating that a patient should be admitted as an inpatient under the diagnosis "Back Pain"?',
      supportingInfo: [
    ...
    {
      body:
        'What are the criteria indicating that a patient should be admitted as an inpatient under the diagnosis "Abdominal Pain"?',
      supportingInfo: [
    ...
    {
      body:
        'What are the criteria indicating that a patient should be admitted as an inpatient under the diagnosis "Headache"?',
      supportingInfo: [
    ...
    {
      body:
        'What are the criteria indicating that a patient should be admitted as an inpatient under the diagnosis "Nausea/Vomiting"?',
      supportingInfo: ["Signs and symptoms of shock despite ED treatment"],
    },
    {
      body:
        'What are the criteria indicating that a patient should be admitted as an inpatient under the diagnosis "Dizziness"?',
      supportingInfo: [
    ...
    {
      body:
        'What are the criteria indicating that a patient should be admitted as an inpatient under the diagnosis "Syncope"?',
      supportingInfo: [
        ">85 years old",
    ...
    {
      body:
        'What are the criteria indicating that a patient should be admitted as an inpatient under the diagnosis "Gait Dysfunction"?',
      supportingInfo: [
    ...
    {
      body:
        'What are the criteria indicating that a patient should be admitted as an inpatient under the diagnosis "TIA"?',
      supportingInfo: [
