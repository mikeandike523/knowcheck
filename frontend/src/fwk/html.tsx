...
export const Span = forwardRef<AsElementType["span"], SpanProps>(
  (props, ref) => {
...
export const Details = forwardRef<AsElementType["details"], DetailsProps>(
  (props, ref) => {
...
export const Summary = forwardRef<AsElementType["summary"], SummaryProps>(
  (props, ref) => {
...
export const Abbr = forwardRef<AsElementType["abbr"], AbbrProps>(
  (props, ref) => {
...
export const Address = forwardRef<AsElementType["address"], AddressProps>(
  (props, ref) => {
...
export const Area = forwardRef<AsElementType["area"], AreaProps>(
  (props, ref) => {
...
export const Article = forwardRef<AsElementType["article"], ArticleProps>(
  (props, ref) => {
...
export const Aside = forwardRef<AsElementType["aside"], AsideProps>(
  (props, ref) => {
...
export const Audio = forwardRef<AsElementType["audio"], AudioProps>(
  (props, ref) => {
...
export const Button = forwardRef<AsElementType["button"], ButtonProps>(
  (props, ref) => {
...
export const Canvas = forwardRef<AsElementType["canvas"], CanvasProps>(
  (props, ref) => {
...
export const Caption = forwardRef<AsElementType["caption"], CaptionProps>(
  (props, ref) => {
...
export const Cite = forwardRef<AsElementType["cite"], CiteProps>(
  (props, ref) => {
...
export const Code = forwardRef<AsElementType["code"], CodeProps>(
  (props, ref) => {
...
export const Colgroup = forwardRef<AsElementType["colgroup"], ColgroupProps>(
  (props, ref) => {
...
export const Data = forwardRef<AsElementType["data"], DataProps>(
  (props, ref) => {
...
export const Datalist = forwardRef<AsElementType["datalist"], DatalistProps>(
  (props, ref) => {
...
export const Dialog = forwardRef<AsElementType["dialog"], DialogProps>(
  (props, ref) => {
...
export const Embed = forwardRef<AsElementType["embed"], EmbedProps>(
  (props, ref) => {
...
export const Fieldset = forwardRef<AsElementType["fieldset"], FieldsetProps>(
  (props, ref) => {
...
export const Figure = forwardRef<AsElementType["figure"], FigureProps>(
  (props, ref) => {
...
export const Footer = forwardRef<AsElementType["footer"], FooterProps>(
  (props, ref) => {
...
export const Form = forwardRef<AsElementType["form"], FormProps>(
  (props, ref) => {
...
export const Head = forwardRef<AsElementType["head"], HeadProps>(
  (props, ref) => {
...
export const Header = forwardRef<AsElementType["header"], HeaderProps>(
  (props, ref) => {
...
export const Hgroup = forwardRef<AsElementType["hgroup"], HgroupProps>(
  (props, ref) => {
...
export const Html = forwardRef<AsElementType["html"], HtmlProps>(
  (props, ref) => {
...
export const Iframe = forwardRef<AsElementType["iframe"], IframeProps>(
  (props, ref) => {
...
export const Input = forwardRef<AsElementType["input"], InputProps>(
  (props, ref) => {
...
export const Label = forwardRef<AsElementType["label"], LabelProps>(
  (props, ref) => {
...
export const Legend = forwardRef<AsElementType["legend"], LegendProps>(
  (props, ref) => {
...
export const Link = forwardRef<AsElementType["link"], LinkProps>(
  (props, ref) => {
...
export const Main = forwardRef<AsElementType["main"], MainProps>(
  (props, ref) => {
...
export const Mark = forwardRef<AsElementType["mark"], MarkProps>(
  (props, ref) => {
...
export const Menu = forwardRef<AsElementType["menu"], MenuProps>(
  (props, ref) => {
